...
<!-- details of our contribution to the CHILDES corpus module in NLTK---didn't we change it? -->
...
<!-- Potentially put some R code to show easy it is to access previous versions? MCF: Nah. -->
...
<!-- SM: How easy is it to implement versioning in the Shiny apps? This would show anyone using the web app the availability of the versions-->
<!-- SM: can people get to these sql files currently on the website?-->
