...
For this reason, we fit a linear mixed effects model (`mod_data`, shown in the plot below) to remedy these concerns.^[All code and analyses are available at https://github.com/langcog/childes-db-paper] 
...
<!-- AS: is this sufficient for mixed effects model explanation? -->
...
The goal of this analysis was to showcase an example of the the steps involved in using `childesr` for exploring the CHILDES dataset, as well as some of the potential hazards in working with a diverse set of corpora that were collectd through various experimental paradigms. 
