...
To account for non-indepenence, we fit a linear mixed effects model with a $gender * age$ (treated as a quadratic predictor) interaction as fixed effects, child identity as a random intercept, and $gender * age$ by language as a random slope.^[All code and analyses are available at https://github.com/langcog/childes-db-paper]
