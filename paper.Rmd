...
<!-- what did you mean here? don't rows = records; SM: that's a description of a database in general; we can make a specific assertion about childes-db-->
...
Other tables in the database are hierarchical collections built out of tokens -- *utterance*, *transcription*, *corpus*, and *collection* -- which store attributes appropriate for each level of description.
...
A *transcription* consists of one or more utterances and includes the date collected, the name of the target child, and age in days (if defined), and the filename from CHILDES.
...
- Filled pauses 
- Reformulations, word revision, and phrase revision, e.g. \textlt what did you\textgt [//] how can you see it ?
