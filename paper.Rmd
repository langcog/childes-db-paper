...
Manty of the other tables in the database are hierarchical collections built out of tokens -- *utterance*, *transcript*, *corpus*, and *collection* -- which store attributes appropriate for each level of description.
