...
The lexical statistics of languaeg input to children have long been an object of study in child language acquisition research, with ocurrence frequency specifically posited to have critical importance [see e.g., @ambridge2015 for review]. 
The Frequency Counts app allows users to enter a word (or words) in a text box and see the frequency (in parts per million) in which this word was uttered across a child's age for a particular subset of the data, whether for an individual child in the Brown corpus or for all Spanish speaking children and their mothers. 
...
The syntactic complexity and lexial diversity of children's speech are similarly critical metrics for acquisition researchers [@miller1981,@watkins1995].
...
<!-- MCF: need citations for voc-d and MTLD -->
