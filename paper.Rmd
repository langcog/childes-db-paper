...
For example, currently childes-db operates only on transcript data, without links to the underlying media files; these linkages facilitate deeper analyses of phonology, prosody, social interaction, and many other aspects of acquisition. <!-- AS: why are these links important? Does that mean users have to copy them from childesr and navigate to a website? Also, phonology prosody etc is available through tiers so a little confused -->
