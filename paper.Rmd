...
For example, childes-db currently operates only on transcript data, without links to the underlying media files; in the future, adding such links may facilitate further computational and manual analyses of phonology, prosody, social interaction, and other phenomena by providing easy access to the video and audio data. <!-- AS: why are these links important? Does that mean users have to copy them from childesr and navigate to a website? Also, phonology prosody etc is available through tiers so a little confused -->
