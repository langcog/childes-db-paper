...
Note that one child in particular, "Leo" in the eponymous corpus, contained transcripts that were a collection of his most complex utterances (recorded by the parents); this child was excluded from the analysis.
